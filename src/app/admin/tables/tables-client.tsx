...
export default function TablesClient({
  ...
  const [form, setForm] = useState({ weddingId: weddings[0]?.id || "", tableNumber: "", tableName: "", capacity: "10" });
  ...
  const handleAdd = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setShowAdd(false);
        setForm({ weddingId: weddings[0]?.id || "", tableNumber: "", tableName: "", capacity: "10" });
      }
    } finally {
      setLoading(false);
    }
